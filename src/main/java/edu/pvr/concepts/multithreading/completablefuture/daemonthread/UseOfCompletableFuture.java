...
// Combine all futures and process results when all complete
    ...
    public static void main(String[] args) {
        ...
        UseOfCompletableFuture useOfCompletableFuture = new UseOfCompletableFuture();
        useOfCompletableFuture.completableFutureUseCase();

        System.out.println("Main thread completed!\nOther threads also will be completed since daemon threads do not keep the JVM alive.");
    }
}
